...
class NoteAddUpdateView(TestCase):
    ...
    def test_update_note_1(self):
        ...
        data = {"note_id": self.note_1.id, "text_recto": "hello world", "text_verso": "some text",
                'studie_recto': True, 'studie_verso': True}
        response = self.client.post(
        ...
        nbr_note_progression = StudiesNotesProgression.objects.filter(
            notes_id=self.note_1.id, user_id=self.user_a.id).count()
    ...
    def test_update_note_2(self):
        ...
        data = {"note_id": self.note_1.id, "text_recto": "hello world", "text_verso": "some text",
                'studie_recto': False, 'studie_verso': False}
        self.client.post(
            reverse("studies:specific_note", kwargs={'chapter': self.chapter_1.id, 'note': self.note_1.id}), data, follow=True
        )
        nbr_note_progression = StudiesNotesProgression.objects.filter(
    ...
    def test_update_note_3(self):
        ...
        data = {"note_id": self.note_2.id, "text_recto": "hello world", "text_verso": "some text",
                'studie_recto': False, 'studie_verso': True}
        self.client.post(
            reverse("studies:specific_note", kwargs={'chapter': self.chapter_1.id, 'note': self.note_2.id}), data, follow=True
        )
        nbr_note_progression = StudiesNotesProgression.objects.filter(
            notes_id=self.note_2.id, user_id=self.user_a.id).count()
    ...
    def test_update_note_5(self):
        ...
        data = {"note_id": self.note_3.id, "text_recto": "hello world", "text_verso": "some text",
                'studie_recto': True, 'studie_verso': True}
        self.client.post(
            reverse("studies:specific_note", kwargs={'chapter': self.chapter_1.id, 'note': self.note_3.id}), data, follow=True
        )
        nbr_note_progression = StudiesNotesProgression.objects.filter(
            notes_id=self.note_3.id, user_id=self.user_a.id).count()
        self.assertEqual(nbr_note_progression, 2)
        # test update_note_for_student
