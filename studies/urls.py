...
urlpatterns = [
    ...
    path("teacher/<int:book>/<int:error>", views.teacher_view, name="teacher_page"),
    path("teacher/add/<int:book>", views.add_new_student_in_book_view, name="add_new_student"),
    ...
    path("delete/chapter/<int:chapter>", views.delete_chapter_view, name="delete_chapter"),
    path("delete/note/<int:note>", views.delete_note_view, name="delete_note"),
    
    
    # teacher - student subscription
    path("unsubscribe/<int:book>", views.unsubscribe_book_view, name="unsubscribe_book"),
