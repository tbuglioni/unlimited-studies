# Generated by Django 3.2.2 on 2021-08-29 16:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user_fonction",
                    models.CharField(
                        choices=[("owner", "owner"), ("student", "student")],
                        default="owner",
                        max_length=255,
                    ),
                ),
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["user", "notes"], name="studies_stu_user_id_2108ec_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="studiesnotes",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["user", "date"], name="studies_glo_user_id_b97d2d_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="globaldailyanalysis",
            index=models.Index(
                fields=["user", "date"], name="studies_glo_user_id_7ed0fd_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="chapter",
